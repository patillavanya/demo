...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post instruments_url, params: { instrument: { Title: @instrument.Title, brand: @instrument.brand, price: @instrument.price } }
    end
  ...
  test "should update instrument" do
    patch instrument_url(@instrument), params: { instrument: { Title: @instrument.Title, brand: @instrument.brand, price: @instrument.price } }
